...
<div class=" align-self-center text-center">
   <form action="../model/insertVentas.php" method="POST" id="frmVentas">
...
<script type="text/javascript" >
    $(document).ready(function(){
        $('#tableTemp').load("tableVenTemp.php");
        $('#productoVenta').change(function(){
            $.ajax({
                type:"POST",
                data:"id=" + $('#productoVenta').val(),
                url:"../controller/llenarReporte.php",
                success:function(r){
        ...
        $('#btnagg').click(function(){
            ...
            $.ajax({
                type:"POST",
                data:datos,
                url:"../controller/aggProductTemp.php",
                success:function(r){
                    $('#tableTemp').load("tableVenTemp.php");
