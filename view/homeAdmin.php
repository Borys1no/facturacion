                        ...
                        <table class="table table-striped table-bordered table-list">
                            ...
                            ?>
                                <tbody>
                                    <tr>
                                        <td align="center">
                                            <a href="editarPro.php?id=<?php echo $files['id']; ?>" class="btn btn-default"><em class="fa fa-pencil"></em></a>
                                            <a href="../model/eliminarPro.php?id=<?php echo $files['id']; ?>" class="btn btn-danger"><em class="fa fa-trash"></em></a>
                                        </td>
